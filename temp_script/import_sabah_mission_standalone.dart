...
Future<void> main() async {
  ...
  try {
    ...
    if (jsonData.containsKey('regions')) {
      ...
      for (var regionEntry in regions.entries) {
        ...
        if (regionData.containsKey('pastoral_districts')) {
          final pastoralDistricts = regionData['pastoral_districts'] as Map<String, dynamic>;
          ...
          for (var districtEntry in pastoralDistricts.entries) {
            ...
            if (districtData.containsKey('organized_churches')) {
              final organizedChurches = districtData['organized_churches'] as List<dynamic>;
              for (var church in organizedChurches) {
                if (church is Map<String, dynamic> && church.containsKey('name')) {
                  churches.add({
            ...
            if (districtData.containsKey('companies')) {
              ...
              for (var company in companyList) {
                if (company is Map<String, dynamic> && company.containsKey('name')) {
                  churches.add({
            ...
            if (districtData.containsKey('groups')) {
              ...
              for (var group in groupList) {
                if (group is Map<String, dynamic> && group.containsKey('name')) {
                  churches.add({
            ...
            for (var churchData in churches) {
              final churchStatus = _getChurchStatusFromType(churchData['type'] as String);
            ...
            print('Created ${churches.length} churches/companies/groups in $districtName');
          }
        }
      }
    }
    ...
    print('   • Total imported: ${regionsCreated + districtsCreated + churchesCreated}');
