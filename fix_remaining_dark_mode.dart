...
void main() {
  ...
  final backupDir = Directory(
      'lib/screens_backup_darkmode_${DateTime.now().millisecondsSinceEpoch}');
  ...
  for (var filePath in filesToFix) {
    ...
    final patterns = [
      ...
      [
        RegExp(r'backgroundColor:\s*Colors\.white\s*,'),
        'backgroundColor: Theme.of(context).scaffoldBackgroundColor,'
      ],

      // Card/Container colors
      [
        RegExp(r'color:\s*Colors\.white\s*,'),
        'color: Theme.of(context).cardColor,'
      ],
      [
        RegExp(r'color:\s*Colors\.grey\[50\]\s*,'),
        'color: Theme.of(context).cardColor,'
      ],
      ...
      [
        RegExp(r'color:\s*Colors\.grey\[700\]'),
      ...
      [
        RegExp(r'color:\s*Colors\.grey\[500\]'),
        'color: Theme.of(context).textTheme.bodySmall?.color?.withValues(alpha: 0.7)'
      ],
      [
        RegExp(r'color:\s*Colors\.grey\[400\]'),
        'color: Theme.of(context).dividerColor'
      ],
      [
        RegExp(r'color:\s*Colors\.black87'),
        'color: Theme.of(context).colorScheme.onSurface'
      ],
      [
        RegExp(r'color:\s*Colors\.black54'),
        'color: Theme.of(context).textTheme.bodySmall?.color'
      ],

      // Borders & Dividers
      [
        RegExp(r'color:\s*Colors\.grey\[300\]'),
        'color: Theme.of(context).dividerColor'
      ],
      [
        RegExp(r'color:\s*Colors\.grey\[200\]'),
        'color: Theme.of(context).dividerColor'
      ],
      [
      ...
      // Shadows
      [
        RegExp(r'BoxShadow\(\s*color:\s*Colors\.black\.withOpacity'),
        'BoxShadow(\n            color: Theme.of(context).shadowColor.withOpacity'
      ],
      [
        RegExp(r'BoxShadow\(\s*color:\s*Colors\.grey\.withOpacity'),
        'BoxShadow(\n            color: Theme.of(context).shadowColor.withOpacity'
      ],

      // Specific hardcoded light colors
      [
        RegExp(r'Colors\.blue\.shade50'),
        'Theme.of(context).colorScheme.primaryContainer.withValues(alpha: 0.3)'
      ],
      [
        RegExp(r'Colors\.blue\.shade100'),
        'Theme.of(context).colorScheme.primaryContainer.withValues(alpha: 0.4)'
      ],
      [
        RegExp(r'Colors\.grey\.shade50'),
        'Theme.of(context).colorScheme.surfaceContainerHighest'
      ],
      [
        RegExp(r'Colors\.grey\.shade100'),
        'Theme.of(context).colorScheme.surfaceContainerHighest'
      ],
    ];
    ...
    if (fileReplacements > 0) {
      ...
      print(
          '✓ Fixed ${filePath.split('/').last}: $fileReplacements replacements');
    } else {
