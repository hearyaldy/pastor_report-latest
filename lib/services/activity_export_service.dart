...
class ActivityExportService {
  ...
  Future<void> generateAndSharePDF({
    ...
    try {
      ...
      debugPrint('✅ PDF generated and shared: $fileName');
    } catch (e, stackTrace) {
  ...
  /// Generate Excel report and save/share it
  Future<void> generateAndShareExcel({
    ...
    try {
      ...
      _addExcelRow(
          sheet, currentRow++, ['Rate:', 'RM${kmCost.toStringAsFixed(2)}/km']);
      currentRow++;
      ...
      debugPrint('✅ Excel generated and shared: $fileName');
    } catch (e, stackTrace) {
